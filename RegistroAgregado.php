...
<html lang="en">
    ...
    <body>
        ...
        <h1>Solicitud agregada correctamente</h1>
        <h2>Para continuar navegando vaya al <a href="index.html">inicio</a> del sitio web, si requiere realizar otra solicitud vuelva al <a href="solicitud.html">formulario</a></h2>
<br>
