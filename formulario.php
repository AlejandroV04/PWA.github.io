...
<html lang="en">
    ...
    <body>
            ...
            <div class="main_menu" id="mainNav">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="media/logo.png" width="200" height="140" alt=""><img src="media/logo.png" width="90" height="50" alt=""></a>
							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="basico.html">Básico</a></li>
										<li class="nav-item"><a class="nav-link" href="residencial.html">Residencial</a></li>
										<li class="nav-item"><a class="nav-link" href="empresarial.html">Empresarial</a></li>
									</ul>
								</li>
                                <li class="nav-item"><a class="nav-link" href="solicitud.html">SOLICITAR</a></li>
				...
				<div class="container">
					<div class="banner_content text-center">
						...
						<div class="page_link">
							...
							<a href="basico.html">Solicitud</a>
						</div>
					</div>
				</div>
            </div>
        ...
        <br>
        <center>
        <h1>Ingrese sus datos para solicitar un servicio</h1>

        <h2>Se deben rellenar todos los campos para procesar la solicitud</h2>
<br>
        <form action="agregar.php" method="post">
            ...
            <div class="row mb-3">
                ...
                <select class="form-select" name="localidad">
                    <option selected>Selecciona tu localidad</option>
                    <option value="Boca de lima">Boca de lima</option>
                ...
                <select class="form-select" name="servicio">
                    ...
                    <option value="Mantenimiento a equipo de computo">Mantenimiento a equipo de computo</option>
                    <option value="Reparacion de equipo de computo">Reparacion de equipo de computo</option>
                    <option value="Revisión/diagnóstico">Revisión/diagnóstico</option>
                  </select>
                </div>
                </div>

            <button type="submit" class="btn btn-primary" value="Ingresar">Enviar solicitud</button>
          </form>
          <br>
<!--
        <form action="agregar.php" method="post">
